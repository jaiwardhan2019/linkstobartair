                  ...
                  <td align="left" bgcolor="white" width="35%">	
						...
						<table width="100%" class="tableClass">
							<tr>
								...
								<tr>
									 <td  align="left" width="80%">Miscellaneous / Finance </td>
									 <td  align="center" width="20%"><input type="checkbox"  id="gopsprofile" value="25" onchange="updateProfiletoDataBase(this)" <c:if test = "${fn:contains(userinsubjectgopsprofile,'Finance')}">    checked  </c:if>></td>								 
								</tr>
