            ...
            <div class="container-fluid">
                <div class="row">
					<div class="footer-col col-md-4">
                        <h5 style="color:#0071BA;font-weight:600;">Stobart Air - Link</h5>
                        <div style="color:#0071BA;text-align:justify;font-size:9pt;">                        
                    ...
                    <div class="footer-col col-md-3">
                        <h5 style="font-weight:600;color:#0071BA;">Contact information</h5>
                        <font style="color:#0071BA;font-size:9pt;">
						<!--Dublin address -->
					...
					<div class="footer-col col-md-3">
                        <h5 style="font-weight:600;color:#0071BA;">Our Data Promise</h5>
                        <a style="color:#0071BA;font-size:9pt;" target="_blank"   target="_new">Click Here For Detail</a><br>
                     
                    </div>
                    
                        <div class="footer-col col-md-2">
                        <h5 style="font-weight:600;color:#0071BA;">Around the Web</h5>
