...
<nav class="navbar navbar-default navbar-fixed-top panel-shadow">
    ...
    <div class="navbar-header" >
		...
		<a href="HomePage?emailid=<%=request.getAttribute("emailid")%>&pass=<%=request.getAttribute("pass")%>" class="navbar-brand" data-toggle="tooltip" data-placement="right" title="Link Home Page" style="margin-left:3px;margin-top:04px;padding:0px;" >
			  ...
			  <a href="adminhome" style="font-size:09pt;font-weight:600;color:#FDFEFE;" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-plane" aria-hidden="true"></i> &nbsp;&nbsp;REPORTS <span class="caret"></span></a>
				  ...
				  <ul class="dropdown-menu">
				        ...
				        <c:if test="${profilelist.Flight_Report  == 'Y'}">   
				            <li style="margin-top:3px;margin-bottom:3px;"><a href="flight_mayFly_report?emailid=<%=fullemail%>&airportcode=ALL&airlineCode=ALL" target="_new"  style="font-size:09pt;"><i class="fa fa-database" aria-hidden="true"></i>&nbsp;&nbsp;Flight Report -> MayFly</a></li>
					    </c:if>
					    <c:if test="${profilelist.Reliablity  == 'Y'}"> 
					         <li style="margin-top:3px;margin-bottom:3px;"><a href="reliabilityReportForm?emailid=<%=fullemail%>" target="_new"  style="font-size:09pt;"><i class="fa fa-database" aria-hidden="true"></i>&nbsp;&nbsp;Reliability Report</a></li>
					    </c:if> 
					    
					    <c:if test="${profilelist.ReliablityAction  == 'Y'}"> 
					         <li style="margin-top:3px;margin-bottom:3px;"><a href="reliabilityAction?emailid=<%=fullemail%>" target="_new"  style="font-size:09pt;"><i class="fa fa-database" aria-hidden="true"></i>&nbsp;&nbsp;Reliability Action</a></li>
					    </c:if> 
					    
					     <c:if test="${profilelist.Daily_Summary  == 'Y'}"> 					     
					        <li style="margin-top:3px;margin-bottom:3px;"><a href="flight_daily_summary_report_form?emailid=<%=fullemail%>&airlineCode=ALL" target="_new"  style="font-size:09pt;"><i class="fa fa-database" aria-hidden="true"></i>&nbsp;&nbsp;Daily Summary Report</a></li>
					     </c:if> 
					     
					 
					     <c:if test="${profilelist.Voyager  == 'Y'}">  
					        <li style="margin-top:3px;margin-bottom:3px;"><a href="voyagerReport?emailid=<%=fullemail%>&airlineCode=ALL" target="_new"  style="font-size:09pt;"><i class="fa fa-database" aria-hidden="true"></i>&nbsp;&nbsp;Voyager Report</a></li>
				         </c:if> 
