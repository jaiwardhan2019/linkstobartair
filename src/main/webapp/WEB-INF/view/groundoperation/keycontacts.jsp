		...
		<div class="col-md-3 col-sm-3 col-xs-12" align="center">
			<div class="panel panel-info panel-shadow" style="background-color:rgb(255,255,255) !important; background:url('include/images/contact/hgo.png');background-repeat:no-repeat;background-position: 115% 100%;">
				<div class="panel-body">
					...
					<br>
					<font style="font-size:9pt;color:black;"><i class="fa fa-envelope-o fa-fw"></i> Alison.Smith@stobartair.com</font>
					<br><font style="font-size:9pt;color:black;"><i class="fa fa-volume-control-phone fa-fw"></i>+353 868127370</font>
		...
		<div class="col-md-3 col-sm-3 col-xs-12" align="center">
			<div class="panel panel-info panel-shadow" style="background-color:rgb(255,255,255) !important; background:url('include/images/contact/gosm.png');background-repeat:no-repeat;background-position: 115% 100%;">
				<div class="panel-body" >
					...
					<br /><font style="font-size:9pt;color:black;"><i class="fa fa-volume-control-phone fa-fw"></i> +353 86 778 7473</font>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3 col-sm-3 col-xs-12" align="center">
			<div class="panel panel-info panel-shadow" style="background-color:rgb(255,255,255) !important; background:url('include/images/contact/gosm.png');background-repeat:no-repeat;background-position: 115% 100%;">
				<div class="panel-body" >
					...
					<br /><font style="font-size:9pt;color:black;"><i class="fa fa-volume-control-phone fa-fw"></i> +353 86 838 5092</font>
				</div>
			</div>
		</div>
		...
		<div  align="center" style="width:65%;">
			...
			<div class="panel panel-primary" style="background:rgba(255,255,255);">
					...
					<div class="panel-heading" style="background:#0070BA;">
						<h3 class="panel-title"> Key Contacts
				...
				<div class="panel-body">
					<table class="table" align="center" style="background:rgba(255,255,255);">	    
							<tbody>
							<tr>
								<td ><b>Head of Ground Operations</b></td>
								<td >Alison Smith </td>
								<td >Alison.smith@stobartair.com </td>
								<td >Mobile: +353 86 812 7370</td>
							</tr>
						<tr>
								<td ><b>Ground Operations Safety Manager </b></td>
								<td >Rachel Crampton  </td>
								<td >Rachel.crampton@stobartair.com </td>
								<td >Mobile: +353 86 778 7473</td>
							</tr>
						<tr>
								<td ><b>Ground Operations Managers  </b></td>
								<td >John Dillon   </td>
								<td >John.dillon@stobartair.com </td>
								<td >Mobile: +353 86 140 1522</td>
							</tr>

						<tr>
								<td ></td>
								<td >Katherine Doogan </td>
								<td >Katherine.doogan@stobartair.com </td>
								<td >Mobile: +353 86 600 2086</td>
							</tr>
						<tr>
								<td ></td>
								<td >Dan Evans  </td>
								<td >Dan.evans@stobartair.com </td>
								<td >Mobile: +44 7720 953 292</td>
							</tr>
						<tr>
						...
						<tr>
								<td ><b>Dublin Airport Duty Manager  </b></td>
								<td >Duty Manager </td>
								<td >Dub.dutymanager@stobartair.com</td>
								<td >Mobile: +353 86 838 5092</td>
							</tr>
