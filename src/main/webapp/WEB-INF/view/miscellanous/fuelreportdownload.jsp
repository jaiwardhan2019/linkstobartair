...
function Search_Invoice() {
		...
		document.fuelinvoice.action = "populatefuelinvoice";
...
function Download_ExcelReport(){
		 ...
		 var urldetail ="downloadfuleinvoiceinexcelfile?emailid="+emailId;		 
		 if(document.getElementById("financialyear").value == "" && document.getElementById("batch").value == "" && document.getElementById("invoiceno").value == ""){
			 urldetail = urldetail +"&financialyear="+getCurrentYear();
	     }
		 else
		 {
			 urldetail = urldetail +"&financialyear="+document.getElementById("financialyear").value;	
		 }	
		 ...
		 $.ajax({
				  ...
				  {
		      	     document.getElementById("downloading").innerHTML = "<img src='xls.png'> &nbsp;<b>  Download  </b> &nbsp;<i class='fa fa-download fa-lg' aria-hidden='true'></i>";
		      	     window.location = emailId+"/fuelInvoiceReport.xls";	           
					        ...
					        <span style="display:block" id="convertbtn">
					           <input type="button"  class="btn btn-primary" value="Search Invoice" onclick="Search_Invoice();" /> 
					                ...
					                <c:if test="${fn:length(invoicelist) > 0}">
		                 	              <button onclick="Download_ExcelReport();" id="downloading" type="button" class="btn  btn-success"> 
        	                                  <img src="xls.png"> &nbsp;<b>  Download  </b> 
        	                               </button>
        	                        </c:if>
				      ...
				      <tbody>
				      	       ...
				      	       <tr align="left"> 
	                               <td colspan="10" align="left">
	                                   <span style="font-weight:500;font-size:10pt;color:blue;">
	                                         ${searchlabel}         	             
	                                    </span>   
	                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
	                                    <span style="font-weight:900;font-size:8pt;color:red;">
	                                         On the screen you might see less invoice , To see full invoice list please download Excel Report 
	                                    </span>                            
        	                       </td>
