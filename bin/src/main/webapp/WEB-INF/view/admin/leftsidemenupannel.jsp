					...
					<div class="panel panel-info">
						<div class="panel-heading" style="background:#fff;">
							<span style="font-weight:600;cursor:pointer;color:#000;" data-toggle="collapse" data-parent="#accordion" data-target="#collapse1">
								People Profile<span class="servicedrop1 glyphicon glyphicon-chevron-up pull-right"></span>
							</span>
						</div>
						
						<div id="collapse1" class="panel-collapse collapse in">
							<ul class="nav nav-pills nav-stacked">
							  <li><a href="#" class="leftlist" style="font-size:9.2pt;padding-top:8px;padding-bottom:8px;border-radius:0px;">Manage</a></li>
							  <li><a href="#" class="leftlist" style="font-size:9.2pt;padding-top:8px;padding-bottom:8px;border-radius:0px;">Profile</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="panel panel-info">
						<div class="panel-heading" style="background:#fff;">
							<span style="font-weight:600;cursor:pointer;color:#000;" data-toggle="collapse" data-parent="#accordion" data-target="#collapse2">
								Collapsible Group 2 <span class="servicedrop2 glyphicon glyphicon-chevron-down pull-right"></span>
							</span>
						</div>
